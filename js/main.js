...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ragrid_demo_element__ = __webpack_require__(73);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__rxstore__ = __webpack_require__(74);
...
var RagridDemo = function (_HTMLElement) {
  _inherits(RagridDemo, _HTMLElement);

  function RagridDemo() {
    _classCallCheck(this, RagridDemo);

    return _possibleConstructorReturn(this, (RagridDemo.__proto__ || Object.getPrototypeOf(RagridDemo)).apply(this, arguments));
  }

  _createClass(RagridDemo, [{
    key: 'createdCallback',
    value: function createdCallback() {
      ...
      this.panel_controls = [{
        ...
        buttons: [{ attr: 'horizontally-aligned', val: 'left', title: 'Horizontally align to the left' }, { attr: 'horizontally-aligned', val: 'center', title: 'Horizontally align to the center' }, { attr: 'horizontally-aligned', val: 'right', title: 'Horizontally align to the right' }, { attr: 'vertically-aligned', val: 'top', title: 'Vertically align to the top' }, { attr: 'vertically-aligned', val: 'center', title: 'Vertically align to the center' }, { attr: 'vertically-aligned', val: 'bottom', title: 'Vertically align to the bottom' }]
      }, {
        section: 'distribute-objects',
        buttons: [{ attr: 'horizontally-distributed', val: 'between', title: 'Horizontally distribute space between, edge to edge' }, { attr: 'horizontally-distributed', val: 'around', title: 'Horizontally distribute space evenly' }, { attr: 'horizontally-distributed', val: 'equal', title: 'Horizontally fill all space' }, { attr: 'vertically-distributed', val: 'between', title: 'Vertically distribute space between, edge to edge' }, { attr: 'vertically-distributed', val: 'around', title: 'Vertically distribute space evenly' }, { attr: 'vertically-distributed', val: 'equal', title: 'Vertically fill all space' }]
      }, {
    ...
    value: function attachedCallback() {
      ...
      this.grid$ = this.Ragrid.store$.subscribe(function (grid) {
        return _this2.render(grid);
      });

      this.align_panel$ = __WEBPACK_IMPORTED_MODULE_0_rxjs__["Observable"].fromEvent(this, 'click').filter(function (e) {
        return e.target.hasAttribute('data-attr-key');
      }).map(function (e) {
        var new_state = {};
    ...
    value: function render(grid) {
      this.innerHTML = '\n      <div grid="columns">\n        <nav>\n          <div class="align-panel">\n            ' + this.panel_controls.reduce(function (controls, control) {
...
/* unused harmony default export */ var _unused_webpack_default_export = (RagridDemo);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_rxjs__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_rxjs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_rxjs__);
/* harmony export (immutable) */ __webpack_exports__["a"] = RxStore;
...
function RxStore(initial_state, reducers) {
  ...
  store$ = (_ref = new __WEBPACK_IMPORTED_MODULE_0_rxjs__["BehaviorSubject"](initial_state)).merge.apply(_ref, _toConsumableArray(Object.values(streams))).scan(function (state, reducer) {
...
function Logger(prefix, observable) {
  return observable.scan(function (prevState, nextState) {
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(68), __webpack_require__(349)))
