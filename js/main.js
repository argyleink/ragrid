...
var RagridDemo = function (_HTMLElement) {
  ...
  _createClass(RagridDemo, [{
    ...
    value: function createdCallback() {
      this.controls = [{
        buttons: [{ attr: 'horizontally-aligned', val: 'left' }, { attr: 'horizontally-aligned', val: 'center' }, { attr: 'horizontally-aligned', val: 'right' }, { attr: 'vertically-aligned', val: 'top' }, { attr: 'vertically-aligned', val: 'center' }, { attr: 'vertically-aligned', val: 'bottom' }]
      }, {
        buttons: [{ attr: 'horizontally-distributed', val: 'around' }, { attr: 'horizontally-distributed', val: 'between' }, { attr: 'horizontally-distributed', val: 'equal' }, { attr: 'vertically-distributed', val: 'around' }, { attr: 'vertically-distributed', val: 'between' }, { attr: 'vertically-distributed', val: 'equal' }]
      }, {
        buttons: [{ attr: 'direction', val: 'rows' }, { attr: 'direction', val: 'columns' }]
      }];

      // new RxStore store from number seed, followed by object of reducers
      this.Ragrid = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__rxstore__["a" /* RxStore */])({
        'direction': 'columns',
    ...
    value: function attachedCallback() {
      ...
      this.clicks$ = __WEBPACK_IMPORTED_MODULE_0_rxjs__["Observable"].fromEvent(this, 'click').filter(function (e) {
        ...
        return _this2.Ragrid.actions.set(action);
      });
    }
  }, {
    ...
    value: function render(grid) {
      this.innerHTML = '\n      <div grid="columns">\n        <nav>\n          ' + this.controls.reduce(function (controls, control) {
        return controls + '\n            <div class="controls" grid="rows" vertically-distributed="equal">\n              <div grid="columns" horizontally-distributed="equal">\n                ' + control.buttons.reduce(function (items, item) {
          return items + '<button data-attr-key="' + item.attr + '" data-attr-val="' + item.val + '"></button>';
        }, '') + '\n              </div>\n            </div>\n            ';
